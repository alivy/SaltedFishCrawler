...
namespace Utils.Help
{
    ...
    public class WebHelper
    {
        ...
        //资源网站域名
        public static string StrUrl = System.Configuration.ConfigurationManager.AppSettings["Domain"];
        ...
        public static string Post(string url, string json, int iTimeoutSeconds = 30)
        {
